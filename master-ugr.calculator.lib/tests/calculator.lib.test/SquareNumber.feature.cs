...
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "", "Square Root Calculation", "  This feature calculates the square root of a number and validates the result.", ProgrammingLanguage.CSharp, featureTags);
        ...
        [Xunit.InlineDataAttribute("-4", "Exception", new string[0])]
        [Xunit.InlineDataAttribute("-16", "Exception", new string[0])]
        [Xunit.InlineDataAttribute("-25", "Exception", new string[0])]
        [Xunit.InlineDataAttribute("-28", "Exception", new string[0])]
        [Xunit.InlineDataAttribute("8", "2.8284271247461903", new string[0])]
        [Xunit.InlineDataAttribute("45", "6.708203932499369", new string[0])]
...
#line hidden
#line 7
    testRunner.Then(string.Format("the calculated square root should be {0}", result), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
